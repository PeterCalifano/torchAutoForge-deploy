...
# ros-dev-tools is provided by the ROS 2 repository.
...
# Image construction runs as root, so install the environment system-wide for
# the non-root devcontainer user.
